...
def obsidian_rewrite_materials_review_note(
    ...
    logger.info(
        "[obsidian_rewrite_materials_review_note] review_note_path=%r topic=%r vault_dir=%r overwrite_existing=%s has_model_config=%s",
        review_note_path,
        topic,
        vault_dir,
        overwrite_existing,
    ...
    write_vault_fields = _vault_result_fields(
        write_result,
        requested_default=effective_vault_dir,
        effective_default=effective_vault_dir,
    )
